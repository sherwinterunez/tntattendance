...
$settings_verticaldisplaynumberofprevious = getOption('$SETTINGS_VERTICALDISPLAYNUMBEROFPREVIOUS',10);
...
<div id="contentmiddles">
	...
	<div id="contentright">
		...
		<div id="info">
			...
			<div class="ilabel">DB:</div>
			<div id="db"><?php echo getTotalStudentCurrentSchoolYear(); ?></div>
			<?php } ?>
			<div class="ilabel">IN:</div>
			<div id="in" class="ilabel">0</div>
			<div class="ilabel">OUT:</div>
			<div id="out" class="ilabel">0</div>
			<div class="ilabel">LATE:</div>
			<div id="late" class="ilabel">0</div>
			<br class="br" />
		</div>
	...
	<div id="contentmid">
		<div id="contentprevious">
			<div id="contentpreviousdiv">
				<?php for($i=0;$i<$settings_verticaldisplaynumberofprevious;$i++) { ?>
