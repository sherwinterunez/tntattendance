...
jQuery(document).ready(function($) {
	...
	var studentphotobgHeight = parseInt(contentleftWidth * 0.45);
	...
	var contenttopHeightNew = height * 0.0538;
	var contentbottomHeightNew = height * 0.0538;
	...
	jQuery("#marquee").css({height:contentbottomHeightNew*.9,fontSize:(contentbottomHeightNew*.8)+'px',paddingBottom:(contentbottomHeightNew*.2)+'px'});
